{
	...
	predicate: {
		buildDefinition: {
			...
			externalParameters: {
				workflow: {
					// ref:        "refs/tags/container_keyless/v1.0.0"
		...
		runDetails: {
			builder: {
				id: "https://github.com/lkhn/sscs-reusable-workflows/.github/workflows/reusable_release_container_keyless.yaml@refs/heads/main"
			}
			metadata: {
